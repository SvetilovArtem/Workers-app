...
const ContentProfile = ({ email }:ContentProfileProps) => {
  return (
    <div className={styles.content}>
        <div className={styles.desc}>Клиенты видят в нем эксперта по вопросам разработки комплексных решений финансовых продуктов, 
        ...
        <div className={styles.info}>
            <div className={styles.phone}><IconCreator type='phone' /><span>+7 (954) 333-44-55</span></div>
            <div className={styles.email}><IconCreator type='email' /><span>{email}</span></div>
        </div>
    </div>
  )
}
